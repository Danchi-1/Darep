...
export default function SetupModal({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 dark:bg-black/80 p-4 backdrop-blur-sm">
      <div
        className="w-full max-w-lg rounded-2xl bg-white dark:bg-neutral-900 shadow-2xl border border-transparent dark:border-neutral-800 transition-colors duration-200"
        role="dialog"
        aria-modal="true"
      ...
      >
        <div className="flex items-center justify-between border-b border-neutral-100 dark:border-neutral-800 px-6 py-4">
          <div>
            <h2 id="setup-title" className="text-lg font-semibold text-neutral-900 dark:text-white">
          ...
          {onClose && (
            <button
              onClick={onClose}
              className="rounded-full p-2 text-neutral-400 dark:text-neutral-500 hover:bg-neutral-100 dark:hover:bg-neutral-800 hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors"
