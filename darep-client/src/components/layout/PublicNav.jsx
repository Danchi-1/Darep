...
export default function PublicNav() {
  return (
    <nav className="relative flex items-center justify-between px-6 py-4 bg-white dark:bg-black border-b border-neutral-200 dark:border-neutral-800 transition-colors duration-200">
